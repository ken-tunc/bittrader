...
data class StrategyParamsSummaryRequest(val productCode: ProductCode, val duration: Duration) {

    companion object {
        private const val PRODUCT_CODE_KEY = "product_code"
        private const val DURATION_KEY = "duration"

        fun from(params: MultiValueMap<String, String>): StrategyParamsSummaryRequest {
            ...
            return StrategyParamsSummaryRequest(productCode, duration)
        }
    }

    fun toStrategyValuesId() = StrategyValuesId(productCode, duration)
